        ...
        describe(`In ${lang} language`, function() {
            ...
            it('should be able to search for cards', function() {
                ...
                cy.location('pathname')
                    .should('end.with', '/catalog/source:rug02-rug03');

                cy.getQueryParameter('q')
                    .should('eq', 'test');
            });
            ...
            it('should be able to load a card detail page', function() {
                ...
                cy.location('pathname')
                    .should('match', /\/catalog\/rug0[23]:\d{9}$/);
            
                cy.getQueryParameter('q')
                    .should('eq', 'test');

                cy.getQueryParameter('source')
                    .should('eq', 'rug02-rug03');
            });
